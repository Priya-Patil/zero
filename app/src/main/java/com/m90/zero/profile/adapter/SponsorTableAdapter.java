...
public class SponsorTableAdapter extends RecyclerView.Adapter<SponsorTableAdapter.MyViewHolder> {

    private static final String TAG = "SponsorTableAdapter";
    ...
    public SponsorTableAdapter(Activity context, ArrayList<WalletDetailsResponse> list) {
        this.list = list;
        mContext = context;
    }

    public SponsorTableAdapter(Activity context, ArrayList<WalletDetailsResponse> list, ItemClickListener itemClickListener){
        mContext = context;
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, final int i) {
        ...
        Log.e(TAG," chkchk "+item.sponsor.sponsor_code);
        ...
        viewHolder.tv_credit.setText(String.valueOf(String.format("%.2f", Double.parseDouble(item.credit_amount))));
        viewHolder.tv_debit.setText(String.valueOf(String.format("%.2f", Double.parseDouble(item.debit_amount))));
        viewHolder.tv_balance.setText(String.valueOf(String.format("%.2f", Double.parseDouble(item.balance_amount))));
    ...
    public void updateList(ArrayList<WalletDetailsResponse> list){
        list = list;
        notifyDataSetChanged();
    }
}
